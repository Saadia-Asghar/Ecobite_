        ...
        >
            ...
            >
                {banner.type === 'image' && banner.imageUrl ? (
                    ...
                    <div className={`p-6 flex items-center justify-between bg-gradient-to-r ${banner.backgroundColor || 'from-blue-50 to-blue-100'} dark:from-gray-800 dark:to-gray-700`}>
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <h3 className="text-xl font-bold text-forest-900 dark:text-ivory">{banner.content}</h3>
                                </div>
                                <p className="text-forest-600 dark:text-forest-300 text-sm max-w-xl">
                                    {banner.description}
                                </p>
                            </div>
                        </div>
                        <div className="hidden md:flex items-center gap-2 text-forest-900 dark:text-ivory font-bold text-sm bg-white/20 px-4 py-2 rounded-lg hover:bg-white/30 transition-colors">
